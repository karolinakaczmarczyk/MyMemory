    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (memoryCard.isFaceUp) {
                if (memoryCard.imageUr != null) {
                    Picasso.get().load(memoryCard.imageUr).placeholder(R.drawable.ic_image).into(imageButton)
                } else {
                    imageButton.setImageResource(memoryCard.identifier)
                }
            } else {
                imageButton.setImageResource(R.drawable.leaves)
            }
